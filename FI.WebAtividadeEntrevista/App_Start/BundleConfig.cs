...
namespace WebAtividadeEntrevista
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/formMasks").Include(
                     "~/Scripts/Masks/FI.FormMasks.js"));


            bundles.Add(new ScriptBundle("~/bundles/viaCep").Include(
                     "~/Scripts/ViaCep/FI.ConsumoViaCep.js"));
